...
import { defaultProducts, Product } from "./ProductContent";
                                    ...
                                    <div className="row">
                                        <div className="col-xl-6 col-lg-6 col-md-6">
                                            <div className="single-product-style2__img">
                                                <Link href={"/product-details"}>
                                                    <Image src={product.image} alt={product.name} width={232} height={300} />
                                                    <Image src={product.image} alt={product.name} width={232} height={241} />
                                                </Link>
