...
const BlogDetailsRight: React.FC = () => {
    ...
    const categories: Category[] = [
        { id: 1, name: "Residential Cleaning", count: 15, link: "/residential-cleaning" },
        { id: 2, name: "Commercial Cleaning Design", count: 20, link: "/commercial-cleaning" },
        { id: 3, name: "Eco-Friendly Cleaning", count: 42, link: "/deep-cleaning" },
        { id: 4, name: "Cleaning Tips and Tricks", count: 89, link: "/office-cleaning" },
    ];
